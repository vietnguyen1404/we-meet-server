...
> = {
  ...
  meta: {
    modelProps: 'user' | 'meeting' | 'membership';
 ...
 */
export type EnumMeetingRoleFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'MeetingRole'
>;
 ...
 * Reference to a field of type 'MeetingRole[]'
 */
export type ListEnumMeetingRoleFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'MeetingRole[]'
>;
