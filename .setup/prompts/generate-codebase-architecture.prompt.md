...
"Create a comprehensive architecture document at `/docs/architecture.md` that thoroughly analyzes the architectural patterns in the codebase to serve as a definitive reference for maintaining architectural consistency. Use the following approach:
