...
"Analyze the project's folder structure and create a comprehensive document at `/docs/folder-structure.md` that serves as a definitive guide for maintaining consistent code organization. Use the following approach:
